...
/**
 * Returns all the information that we know about the current Aerostem server.
 *
 * @param  {Object}  state  the state of the application
 * @return {Object} all the information that we know about the current Aerostem
 ...
 *     current Aerostem server to any additional information we know about the
 *     feature.
 */
const getCurrentServerFeatures = (state) => state.servers.current.features;

/**
 * Returns the license that is currently active on the connected Aerostem
 * server.
 *
 * @param  {Object}  state  the state of the application
 * @return {Object[]}  an object describing the license active on the currently
 *     connected Aerostem server
 */
...
/**
 * Returns the version number of the currently connected Aerostem server.
 *
 * @param  {Object}  state  the state of the application
 * @return {string}  version number of the currently connected Aerostem server
 */
...
/**
 * Returns whether we are connected to the remote Aerostem server.
 */
...
/**
 * Returns whether we are currently trying to connect to the remote Aerostem
 * server.
 */
