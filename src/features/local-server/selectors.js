...
/**
 * Returns the list of directories in which a local Aerostem server instance
...
/**
 * Returns the full path to the executable of a local Aerostem server.
 *
 * @param  {Object}  state  the state of the application
...
/**
 * Returns whether the full path to the executable of a local Aerostem server
 * was found.
 *
 * @param  {Object}  state  the state of the application
...
/**
 * Returns whether a local Aerostem server launched directly by the Aerostem
