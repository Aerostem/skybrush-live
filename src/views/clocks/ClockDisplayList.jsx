/**
 * @file Component that displays the status of Aerostem clocks.
 */
...
/**
 * Presentation component for showing the state of a single Aerostem clock.
 */
...
ClockDisplayListEntry.propTypes = {
  ...
  clock: PropTypes.shape({
    ...
    /** Whether the clock is running according to the Aerostem server */
